...
i = 5
lengthPaths = 2
len_start_list = len(list_of_passwords)
...
while True:
    ...
    while k<len_start_list:
        counts_in_list= len(list_of_passwords)
        for list_number in range(counts_in_list,len_start_list,1):
            password_cur =  list_of_passwords.__getitem__(list_number) + list_of_passwords.__getitem__(k)
            print(password_cur)
